...
run_test "tests/floatingPromiseExitCode.test.ts"
run_test "tests/teardownRaceExitCode.test.ts"
run_test "tests/downloadChecksumDetection.test.ts"
run_test "tests/downloadChecksumVerdict.test.ts"
run_test "tests/serialIoHostStateOnResult.test.ts"
run_test "tests/serialProxyStateOrdering.test.ts"
run_test "tests/checksumVerdictAlwaysLogged.test.ts"
run_test "tests/checksumArmBeforeTerminator.test.ts"
run_test "tests/downloadLogRotationLoss.test.ts"
run_test "tests/headlessCaptureTrust.test.ts"
...
run_test "tests/loggerAutoScrollTail.test.ts"
run_test "tests/loggerShutdownFlush.test.ts"
run_test "tests/serialLogClassification.test.ts"
...
run_test "tests/displayNameRules.test.ts"
run_test "tests/displayNameEnforcement.test.ts"
