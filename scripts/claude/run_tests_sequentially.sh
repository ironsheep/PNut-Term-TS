...
run_test "tests/debuggerDataManager.test.ts"
run_test "tests/debuggerInteraction.test.ts"
run_test "tests/debuggerProtocol.test.ts"
run_test "tests/debuggerRenderer.test.ts"
run_test "tests/disassembler.test.ts"
