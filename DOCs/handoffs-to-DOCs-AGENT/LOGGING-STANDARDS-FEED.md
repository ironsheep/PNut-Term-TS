...
>
> The canonical document is **`DOCs/project-specific/LOGGING-STANDARDS.md`** — which lives in
> a **git-ignored** tree, so this snapshot is the only copy that travels with the handoff and
> the only one visible in the repo's history. Re-snapshotted **2026-09-09** at **v1.0.7**; the
> previous copy was taken at v1.0.0 and predated the **event-vs-mechanism** rule added to
> *System advice* on 2026-08-14. See *What changed in the 2026-09-09 re-snapshot* in this
