...
export function keyValueToString(keyValue: number): string {
  switch (keyValue) {
    case PC_KEY_VALUES.NO_KEYPRESS: return '<no keypress>';
    case PC_KEY_VALUES.LEFT_ARROW: return 'Left Arrow';
    case PC_KEY_VALUES.RIGHT_ARROW: return 'Right Arrow';
    case PC_KEY_VALUES.UP_ARROW: return 'Up Arrow';
    case PC_KEY_VALUES.DOWN_ARROW: return 'Down Arrow';
    case PC_KEY_VALUES.HOME: return 'Home';
    case PC_KEY_VALUES.END: return 'End';
    case PC_KEY_VALUES.DELETE: return 'Delete';
    case PC_KEY_VALUES.BACKSPACE: return 'Backspace';
    case PC_KEY_VALUES.TAB: return 'Tab';
    case PC_KEY_VALUES.INSERT: return 'Insert';
    case PC_KEY_VALUES.PAGE_UP: return 'Page Up';
    case PC_KEY_VALUES.PAGE_DOWN: return 'Page Down';
    case PC_KEY_VALUES.ENTER: return 'Enter';
    case PC_KEY_VALUES.ESC: return 'Esc';
    default:
