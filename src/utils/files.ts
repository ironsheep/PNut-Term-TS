...
// Function to format the current date and time in ISO-style format with local time
// Returns format: 2025-01-12T14:30:22.123 (local time, no 'Z' suffix)
export function getFormattedDateTimeISO(): string {
  const now = new Date();
